    ...
    <form action="" method="post" class="validate">
        <div class="admin-section">
            ...
            <div class="nimble-radio">
                ...
                <small class="dis"><?php _e('<strong>( Defult is 3 Columns )</strong>', 'nimble_portfolio') ?></small>
            </div>
        </div> 
        ...
        <div class="admin-section">
            ...
            <div class="nimble-radio">
                ...
                <small class="dis"><?php _e('<strong>( Defult is Yes )</strong>', 'nimble_portfolio') ?></small>
            </div>
        </div>
        ...
        <div class="admin-section">
            ...
            <div class="nimble-radio">
                ...
                <small class="dis"><?php _e('<strong>( Defult is Round )</strong>', 'nimble_portfolio') ?></small>
            </div>
        </div>
        ...
        <div class="admin-section">
            ...
            <div class="nimble-radio">
                ...
                <small class="dis"><?php _e('Choose hover Icon', 'nimble_portfolio') ?></small>
            </div>
        </div>
